...
class GraphicsProgram3D:
    def __init__(self):
       ...
       # Movement keys
        ...
        skybox = pygame.image.load(sys.path[0] + "/textures/spacesky.webp")
    ...
    def display(self):
        ...
        # self.shader.set_diffuce_texture(self.tex_id)
        ...
        # self.shader.set_material_diffuse(0.5, 0.4, 1.0)
        # self.shader.set_material_specular(0.7, 0.4, 0.5)
        # self.shader.set_material_shininess(10)
        # self.model_matrix.push_matrix()
        # self.model_matrix.add_translation(2.0, 1, 2.0)
        # self.shader.set_model_matrix(self.model_matrix.matrix)
